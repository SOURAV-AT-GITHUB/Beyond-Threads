...
export default function AddToBagButton({ isLoading = false }) {
  return (
    <div className="flex w-full h-[50px] border border-primary group/cart-button">
      <div className="h-full w-3/4 bg-primary text-white flex items-center justify-center px-4">
        {isLoading ? <CircularProgress sx={{color:"white"}}/> : <p>Add To Bag</p>}
      </div>
